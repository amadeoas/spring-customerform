				...
				<div>
					<table>
			        	...
			        	<tr ng-repeat="customer in customers">
			        		...
			        		<td class="field_data">
			        			<a href="#" ng-click="removeEntry($index)" title="${msg_rmvElement}"><span class="glyphicon glyphicon-th-less icon-blue"></span></a> - 
			        			<a href="#" ng-click="addEntry()" title="${msg_addElement}"><span class="glyphicon glyphicon-th-plus icon-blue"></span></a>
			        		</td>
			        	</tr>
			        </table>
