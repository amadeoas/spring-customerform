...
<%--
CustomerForm :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>CustomerForm :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/customerform.css" var="customerformCss"/>
    <link href="${customerformCss}" rel="stylesheet"/>
    ...
    <spring:url value="/resources/js/catalogue.js" var="customerformJs"/>
	<script src="${customerformJs}"></script>
</head>
